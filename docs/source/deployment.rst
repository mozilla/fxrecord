...
3. Configure OpenSSH
   ...
   Then, open the configuration file at ``C:\ProgramData\ssh\sshd_config`` and
   add the following
...
4. Do platform-specific configuration (`fxrecorder`_ or `fxrunner`_).
...
1. Install ImageMagick and FFmpeg.
   ...
   4.2. Download the `latest Windows binary release <imagemagick_>`_ and run it.
   Make sure to also check "Install FFmpeg".
